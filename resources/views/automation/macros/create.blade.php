    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-white leading-tight">
                {{ __('app.create_automation_macro') }}
            </h2>
    ...
    <div class="h-screen bg-gray-50">
        ...
        <div class="bg-white border-b border-gray-200 px-6 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <input type="text" placeholder="{{ __('app.macro_name') }}" class="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        ...
        <div class="h-full relative">
            <!-- ReactFlow Editor -->
            <div id="react-macro-editor" class="w-full h-full"></div>
        </div>
    </div>
