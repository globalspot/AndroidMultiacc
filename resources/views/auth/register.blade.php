...
<head>
    ...
    <title>{{ __('app.app_name') }} - {{ __('app.register') }}</title>
...
<body class="antialiased">
    <div class="min-h-screen flex">
        <!-- Left Side - Branding -->
        <div class="hidden lg:flex lg:w-1/2 gradient-bg hero-pattern">
                ...
                <div class="text-center text-white px-8">
                    ...
                    <div class="space-y-4 text-left max-w-md mx-auto">
                        <div class="flex items-center space-x-3">
                            ...
                            <span class="text-indigo-100">{{ __('app.secure_registration') }}</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-indigo-100">{{ __('app.instant_access') }}</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                                <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-indigo-100">{{ __('app.powerful_features') }}</span>
                        </div>
                    </div>
                </div>
            </div>
